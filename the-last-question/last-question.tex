...
\lettrine[lines=3,lhang=0.16,nindent=0.2em]{  
...
\futuretwo{
\specialinitiald{V}{\addfontfeature{Numbers=Lining}\selectfont J-23X} of Lameth stared into the black depths of the 
...
\futurefour{
\specialinitialc{M}{an} considered with himself, for in a way, Man, mentally, was one. 
