...
\newcommand{\sepa}[0]{\vspace{.8cm} {\centering 

\includegraphics[scale=1.00]{o1.pdf}

}\vspace{.8cm}}

\newcommand{\sepb}[0]{\vspace{.8cm} {\centering 

\includegraphics[scale=1.00]{o7.pdf}

}\vspace{.8cm}}

\newcommand{\sepc}[0]{\vspace{.8cm} {\centering 

\includegraphics[scale=1.00]{o3.pdf}

}\vspace{.8cm}}

\newcommand{\sepd}[0]{\vspace{.8cm} {\centering 

\includegraphics[scale=1.00]{o4.pdf}

}\vspace{.8cm}}

\newcommand{\sepe}[0]{\vspace{.8cm} {\centering 

\includegraphics[scale=1.00]{o5.pdf}

}\vspace{.8cm}}

\newcommand{\sepf}[0]{\vspace{.8cm} {\centering 

\includegraphics[scale=1.00]{o6.pdf}

}\vspace{.8cm}}

\newcommand{\sepg}[0]{\vspace{.8cm} {\centering 

\includegraphics[scale=1.00]{o2.pdf}
...
%{\fontspec{Gotham Black}\small \addfontfeature{LetterSpace=-12.0,WordSpace=.7}{
{\fontspec{Gotham Black}\small \addfontfeature{LetterSpace=-2,WordSpace=.0}{
	\begin{spacing}{20}
	\fontsize{140pt}{8pt}\selectfont
		SHORT\\
		STORY\\
		\mbox{2\hspace{1cm}GO}\\
	\end{spacing}
}} 
		%\rule{10cm}{5cm}
...
me sad. For me, typography has the same role as rhetoric---the way in which
you say something can have a totally different impact. In my opinion this is
equally true for text and typography.
A document which is typeset in a fitting manner has the ability to affect 
the reader in a totally different way.

\begin{center}
	\enquote{\textit{Typography---the voice of the page.}}
\end{center}

Sometimes I take time and make an effort to improve the horrible typesetting 
of wonderful texts. This document is the result of such an effort.
I experimented with various layouts and fonts, at one point I even had
different, increasing futuristic, fonts for the different time chapters.
In the end, however, I decided to go for the more non-obtrusive approach.
I chose to typseet this story after I had read a printed version. When I 
arrived at the last page I took one hand and coverd the ending sentences
...
you either keep it or leave it at some place where others will likely find 
it and read it. Please don't throw it away. 

%\ \\
%\textbf{What should I do now?}\\
...
This text was set using the \textsc{pf din text condensed}. 
The computer output was set using \pc{OCR-A}, a font which was designed
as a mean to make it easier to transform printed texts into a digital 
representation. This is achieved by scanning them and using optical 
...
The sourcecode behind this document is accessible via
\pc{https://github.com/cmichi/reworking-typography}. 
...
suggest you read about names like Spiekermann, Frutiger, Zapf, Hoefler or
Frere-Jones. I would also suggest to start using high-quality typesetting
systems. \enginetwo{} is free software, you can freely download and install 
it right now: \texttt{http://textlive.org}.
