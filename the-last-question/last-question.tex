...
\newcommand{\sepb}[0]{\vspace{.6cm} {\centering 
...
\newcommand{\sepd}[0]{\vspace{.6cm} {\centering 

\includegraphics[scale=1.00]{o4.pdf}

}\vspace{.6cm}}

\newcommand{\sepe}[0]{\vspace{.6cm} {\centering 

\includegraphics[scale=1.00]{o5.pdf}

}\vspace{.6cm}}

\newcommand{\sepf}[0]{\vspace{.6cm} {\centering 

\includegraphics[scale=1.00]{o6.pdf}

}\vspace{.6cm}}

\newcommand{\sepg}[0]{\vspace{.6cm} {\centering 
...
different fonts for the different time chapters.
...
systems. \enginetwo{} is free software and you can download and install them 
right now: \texttt{http://textlive.org}.
